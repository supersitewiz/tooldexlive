...
*/
abstract class Pzdgmailcom_Commercebug_Model_Crossareaajax
{
    ...
    */    
    ...
    {
        $controllers = array('Pzdgmailcom_Commercebug_AjaxController','Pzdgmailcom_Commercebug_AdminajaxController');
        ...
        foreach($controllers as $controller)
        {
            ...
            'Pzdgmailcom_Commercebug_Model_Crossareaajax','appendAction'), self::$_actionNames);
