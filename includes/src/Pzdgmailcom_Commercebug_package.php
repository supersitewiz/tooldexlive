...
class Commercebug_Packager
{
    ...
    {
        $string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Pzdgmailcom_Commercebug><active>true</active><codePool>local</codePool></Pzdgmailcom_Commercebug></modules></config>';
        $string = str_replace('Pzdgmailcom_', $this->namespace . '_',$string);
