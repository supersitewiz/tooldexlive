...
*/
class Pzdgmailcom_Commercebug_Model_Collectorblocksandlayout extends Pzdgmailcom_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Pzdgmailcom_Commercebug') === 0)
            {
                continue;
            }
