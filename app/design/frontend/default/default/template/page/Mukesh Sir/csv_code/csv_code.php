...
while (($data = fgetcsv($handle, 1000, ',')) !== FALSE) {
	...
	$va20 = mysql_real_escape_string($data[9]);
	...
	$val23=date("Y");
			...
			$aaa="INSERT INTO `ustorelocator_location` (`title`,`address`,`latitude`,`longitude`,`address_display`,`notes`,`website_url`,`phone`,`product_types`,`postal_code`) VALUES ('{$val1}','{$val2}','{$val3}','{$val4}','{$val5}','{$val6}','{$val7}','{$val8}','{$val9}','{$va20}')";
