...
/*$aaa="INSERT INTO `contacts` (`CON_CustomerID`,`CON_FirstName`,`CON_LastName`,`CON_Address1`,`CoON_Address2`,`CON_Zip`,`CON_Phone1`,`CON_City`) VALUES ('{$val1}','{$val2}','{$val3}','{$val4}','{$val5}','{$val6}','{$val7}','{$val8}')";*/

$aaa="INSERT INTO `finel500` (`sku`,`brand`,`discontinued`,`similar_product`,`discontinued_product_sku`,`shipping_time`,`upc`) VALUES ('{$val1}','{$val2}','{$val3}','{$val4}','{$val5}','{$val6}','{$val7}')";
